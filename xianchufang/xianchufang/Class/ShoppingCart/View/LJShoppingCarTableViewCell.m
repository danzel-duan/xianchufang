...
- (void)setUpChildrenCellFrame {
    ...
    UIButton *SelectBtn = [[UIButton alloc] initWithFrame:CGRectMake(0,37, 40, 40)];
    ...
    /*** 商品图片 ***/
    self.goodsImageView = [[UIImageView alloc] initWithFrame:CGRectMake(SelectBtn.lj_right , 10, 100, 100)];
