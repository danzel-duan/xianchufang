...
- (void)setChildrenFrame {
    ...
    //订单号
    self.orderNumLabel = [[UILabel alloc] initWithFrame:CGRectMake(11, 0, self.contentView.lj_width * 2 / 3, 35)];
    ...
    //订单状态
    self.orderStatusLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.orderNumLabel.lj_right, 0, self.contentView.lj_width / 3, 35)];
    ...
    UILabel *allLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.goodsTableView.lj_bottom, self.contentView.lj_width - 12, 39)];
    //富文本
    ...
    //分割线
    UIView *cutLine = [[UIView alloc] initWithFrame:CGRectMake(0, allLabel.lj_bottom, self.contentView.lj_width, 0.5)];
...
- (void)addCancelAndPayBtn {
    self.payBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.lj_width - 55, self.goodsTableView.lj_bottom + 45, 44, 25)];
    ...
    self.cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.lj_width - 145, self.goodsTableView.lj_bottom + 45, 81, 25)];
...
#pragma mark --添加确认收货 
- (void)addReceiveBtn {
    self.receiveBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.lj_width - 90, self.goodsTableView.lj_bottom + 45, 81, 25)];
...
#pragma mark --添加待评价
- (void)addEvaluateBtn {
    self.evaluateBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.lj_width - 90, self.goodsTableView.lj_bottom + 45, 81, 25)];
...
- (void)addReturnedGoodsBtn {
    self.returnedGoodsBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.contentView.lj_width - 90, self.goodsTableView.lj_bottom + 45, 81, 25)];
...
- (UITableView *)goodsTableView {
    if (!_goodsTableView) {
        _goodsTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.orderNumLabel.lj_bottom, self.contentView.lj_width, 292) style:UITableViewStylePlain];
