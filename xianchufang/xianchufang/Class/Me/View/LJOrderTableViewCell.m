...
- (void)setChildrenFrame {
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, spaceEdgeH(402))];
    ...
    UILabel *allLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.goodsTableView.lj_bottom, SCREEN_WIDTH - 12, spaceEdgeH(39))];
    //富文本
...
- (void)addCancelAndPayBtn {
    self.payBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - spaceEdgeW(55), self.goodsTableView.lj_bottom + spaceEdgeH(45), spaceEdgeW(44), spaceEdgeH(25))];
    ...
    self.cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - spaceEdgeW(145), self.goodsTableView.lj_bottom + spaceEdgeH(45), spaceEdgeW(81), spaceEdgeH(25))];
...
- (UITableView *)goodsTableView {
    if (!_goodsTableView) {
        _goodsTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, self.orderNumLabel.lj_bottom, SCREEN_WIDTH, spaceEdgeH(292)) style:UITableViewStylePlain];
