...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    return spaceEdgeH(80);
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        LJOrderBaseDetailStatusTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"LJOrderBaseDetailStatusTableViewCell"];
        return cell;
    }else if (indexPath.row == 1){
...
#pragma mark --设置尾部
- (void)setFoot {
    UIView *bgView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, spaceEdgeH(280))];
    bgView.backgroundColor = LJCommonBgColor;
    self.tableView.tableFooterView = bgView;
    
    //背景1：价格背景
    UIView *priceView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, spaceEdgeH(80))];
    ...
    UILabel *orderPrice = [[UILabel alloc] initWithFrame:CGRectMake(spaceEdgeW(10),postPrice.lj_bottom + spaceEdgeH(10), spaceEdgeW(80), spaceEdgeH(16))];
    [orderPrice setFont:LJFontSize15];
    [orderPrice setTextColor:LJFontColor39];
    orderPrice.text = @"订单总价";
    [priceView addSubview:orderPrice];
    ...
    self.orderPrice = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - spaceEdgeW(150),self.postPrice.lj_bottom + spaceEdgeH(10), spaceEdgeW(138), spaceEdgeH(16))];
    [self.orderPrice setFont:LJFontSize15];
    [self.orderPrice setTextColor:LJFontColor39];
    self.orderPrice.text = @"￥43543.00";
    self.orderPrice.textAlignment = NSTextAlignmentRight;
    [priceView addSubview:self.orderPrice];
    ...
    [self.payLabel setTextColor:LJFontColored];
